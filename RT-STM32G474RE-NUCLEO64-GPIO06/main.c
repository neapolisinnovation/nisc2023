...
/*
 * [NISC2023-GPIO06] - Iterate through an array of output lines.
...
#define RLED_LINE   PAL_LINE( GPIOA, 5U ) // ARDUINO A0 (CN8.1)
#define GLED_LINE   PAL_LINE( GPIOA, 6U ) // ARDUINO A1 (CN8.2)
#define BLED_LINE   PAL_LINE( GPIOA, 7U ) // ARDUINO A2 (CN8.3)
